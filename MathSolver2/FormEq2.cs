...
namespace MathSolver2
{
    ...
    {
        public FormEq2(String fullname)
        {
            InitializeComponent() ;
            ...
            this.FormClosing += new FormClosingEventHandler(FormEq2_FormClosing);
        }
        ...
        private void FormEq2_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
    }
